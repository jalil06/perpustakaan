...
<html lang="en">
  ...
  <div class="p-4 mt-5">
    ...
    <div class="card mt-4">
      <h5 class="card-header">Data lengkap Mahasiswa</h5>
      <div class="card-body d-flex flex-wrap gap-4 justify-content-center">
        ...
        <form action="" method="post">
          ...
          <div class="input-group mb-3">
            ...
            <input type="number" class="form-control" placeholder="nim" aria-label="nisn" aria-describedby="basic-addon1" value="<?= $item["nisn"]; ?>" readonly>
            </div>
          <div class="input-group mb-3">
    ...
    <div class="card mt-4">
      ...
      <div class="card-body">
        ...
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Nim</span>
            <input type="number" name="nisn" class="form-control" placeholder="nim" aria-label="nisn" aria-describedby="basic-addon1" value="<?php echo htmlentities($_SESSION["member"]["nisn"]); ?>" readonly>
        </div>
    <!--Ambil data id admin-->
    ...
    <footer class="shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">Created by <span class="text-primary"> Jalil Adriansah</span> © 2024</p>
