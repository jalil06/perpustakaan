...
<html lang="en">
  ...
  <div class="d-flex flex-wrap gap-3">
    <div class="mb-3">
      ...
      <input type="number" class="form-control" placeholder="Nim" name="nisn" id="nisn" value="<?= $item["nisn"]; ?>" readonly>
    </div>
    <div class="mb-3">
      <label for="exampleFormControlInput1" class="form-label">Nama Mahasiswa</label>
      <input type="text" class="form-control" placeholder="Nama Mahasiswa" name="nama" id="nama" value=" <?= $item["nama"]; ?>" readonly>
    </div>
    <div class="mb-3">
